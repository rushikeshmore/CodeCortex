...
Hybrid extraction:
- **Tree-sitter WASM** → symbols (name, kind, signature, startLine, endLine, exported), imports, exports, call edges
...
src/
  ...
  extraction/    — tree-sitter WASM (parser, symbols, imports, calls, queries/*.scm)
